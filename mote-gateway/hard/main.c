 ...
 *
 * @file
 * @brief       802.15.4 to serial gateway
 *
  ...
  if (argc == 2 && strcmp (argv[1], "info") == 0)
      ...
      if (res >= 0)
	{
	  printf ("           Statistics \r\n"
		  ...
		  (unsigned) stats->tx_bytes, (unsigned) stats->tx_success,
  ...
  else if (argc == 3 && strcmp (argv[1], "chan") == 0)
    {
      ...
      gnrc_netapi_set (iff->pid, NETOPT_CHANNEL, 0, (int16_t *) & val,
		       sizeof (int16_t));
      return 0;
    }
  else if (argc == 3 && strcmp (argv[1], "pan") == 0)
    {
      ...
      int16_t val = atoi (argv[2]);
      printf (" val is %d\r\n ", val);
      netapi_set (iff->pid, NETOPT_NID, 0, (int16_t *) & val,
		  sizeof (int16_t));
      return 0;
    }
    ...
    {
      printf
	("net info									Show interface details\n"
